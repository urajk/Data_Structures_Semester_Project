...
namespace Lib.Data.Structures
{
    ...
    public class CDoublyLinkedListNode<T>: CLinkedListNode<T>
    {
        ...
        { 
            ...
            set 
            {
                // If we already had a reference to previous node, it clears its next node reference.
                if (this.previous != null)
                    this.previous.next = null;

                // Ensures that the previous node will consider this node as its next, for the bi-directional link.
                if (value != null)
                    value.next = this;

                // Sets the link to previous node, for the bi-directional link.
                this.previous = value;
            }
        }
        // ................................................................
